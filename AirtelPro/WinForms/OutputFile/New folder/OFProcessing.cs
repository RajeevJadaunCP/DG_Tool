...
namespace DG_Tool.WinForms.OutputFile
{
    public partial class OFProcessing : Form
    {
        ...
        {
            //hsm_IP =  (cbxProfile.Text.ToUpper() == "EUICC") ?  euicc_data_IP:hsm_IP;
            hsm_IP = (cbxProfile.Text.ToUpper() == "EUICC") ? euicc_data_IP : hsm_IP;
        ...
        public int btnImport_Click(int hdid, int lot)
        {
            ...
            try
            {
                ...
                string r4_data = "", r8_data = "" ,euicc_ci_cert_data = "", euicc_eum_cert_data = "", euicc_pri_wrapped_key = "";
        ...
        public string eid_function(int i)
        {
            ...
            data = data+ i.ToString().PadLeft(12, '0');
            long sum = 0;
        ...
        public string euicc_Data_function()
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                    ...
                    //    string responseBody = response.Content.ReadAsStringAsync().Result;
                     response_Data = responseBody;
                        //string logLine = $"[{i}] {DateTime.Now}: {responseBody}";
                        //Console.WriteLine(logLine);
                        //Console.WriteLine(i);
                        //File.AppendAllText(outputFile, logLine + Environment.NewLine);
                    }
                    catch (Exception ex)
                    {
        ...
        private int btnProcessAll_Click()
        {
            ...
            for (int i = 1; i <= records; i++)
            {
                ...
                string euicc_ci_cert_data = "", euicc_eum_cert_data = "", euicc_pri_wrapped_key = "";
