...
namespace AirtelPro.WinForms.OutputFile
{
    public partial class OFProcessing : Form
    {
        ...
        public int btnImport_Click(int hdid, int lot)
        {
            ...
            String Query0 = "SELECT * FROM InPutDataTemplate WHERE CustID = " + OFProcessing.customerID + " and ProfileID =" + OFProcessing.ProfileID + " and  trim(VarText) = 'FL' ";
        ...
        static DataTable ConvertCsvToDataTable(string csvFilePath)
        {
            DataTable dt = new DataTable();
